      ...
      module InstanceMethods
        ...
        def available_filters_with_contacts
          if @available_filters.blank?
            add_available_filter('contacts', :type => :list_optional, :name => l(:field_contacts),
            ...
            add_available_filter('companies', :type => :list, :name => l(:field_companies),
            ...
            add_available_filter('deal', :type => :integer, :name => l(:label_deal),
                                         :values => contacts_for_select(project, :limit => 500)) if !available_filters_without_contacts.key?('deal') && User.current.allowed_to?(:view_deals, project, :global => true)
          else
